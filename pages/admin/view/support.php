          ...
          'columns': [
            ...
            { data: 'rating' },
            {
                ...
                render: function(data, type, row) {
                    return '<a class="pending_sheet text-primary" style="cursor: pointer;">action</a>';
                }
            }
          ]
        });
        ...
        <div class="card my-4">
            <div class="card-header view-tables-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="border-radius-lg pt-4 pb-3">
                <h6 id="table-name" class="text-white text-capitalize ps-3">Ticket Details</h6>
              </div>
            </div>
